...
CommandPlayStart::CommandPlayStart( SCommandServices * _commandServices, PNetworkClient _network )
    : ICommand(_commandServices, _network)
{

}

CommandPlayStart::~CommandPlayStart()
{

}

bool CommandPlayStart::serializeRequestTemplateMethodPart(){
...
bool CommandPlayStart::parseResponseTemplateMethodPart(){
