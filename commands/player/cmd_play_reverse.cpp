...
CommandPlayReverse::CommandPlayReverse( SCommandServices * _commandServices, PNetworkClient _network )
    : ICommand(_commandServices, _network)
{

}

CommandPlayReverse::~CommandPlayReverse()
{

}

bool CommandPlayReverse::serializeRequestTemplateMethodPart(){
...
bool CommandPlayReverse::parseResponseTemplateMethodPart(){
